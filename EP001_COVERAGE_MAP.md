...
|------|---------|------------------|
| **A — Approver credit (CE-001 Published)** | Volume ≥ `approved` by human Publication Approver | **38 / 72 (52.8%)** — CS1-004 (4) + CS1-003 (24) + CS1-005 (4) + CS1-006 (2) + CS1-007 (2) + CS1-008 (2) Learning LOs |
| **B — Live loader inventory** | Packages under `educational_packages/cs1/` with `status: publication_approved` | **54 packages** (8 Alpha/Beta + **5 Gamma** + **27 Delta** + **5 Epsilon** + **3 Zeta** + **3 Eta** + **3 Theta**; EA-006 orphan superseded) |
...
| **Published (Approver credit)** | **38 / 72 (52.8%)** | CS1-004 · 2.1.3–2.1.6 + CS1-005 · 2.2.1–2.2.4 + CS1-006 · 2.3.1–2.3.2 + CS1-007 · 2.4.1–2.4.2 + CS1-008 · 2.5.1–2.5.2 + CS1-003 · 4.1.1–5.1.9 |
...
| Live loader packages (`publication_approved`) | **54** | Alpha 4 + Beta 4 + Gamma 5 + Delta 27 + Epsilon 5 + Zeta 3 + Eta 3 + Theta 3 (orphan superseded) |
| Missing | **25 / 72** | Remaining spine after pipeline (next LIVE open after Wave 6: **2.6**; sections 3 / 5.2+ etc.) |
| Continuity Front (Approver / LIVE) | **Closed through 2.5.2** / CT-R1 | RO-001 · RO-003 · RO-004 · RO-005 · RO-006 |
| Continuity Front (catalogue / pipeline) | **Open at 2.6** (provisional next) | Wave 6 LIVE-complete · Wave 7 not started |
| Trust Remediation Front | **4.1 → 4.2 → 5.1** | Wave 2 **LIVE Verified** (RO-002) — Missing* cleared for 4.2 |
| Pipeline (Under Authoring) | **0 Learning LOs** | — |
...
|-------|----------|--------|--------|
| **Opening Continuity Front (student LIVE)** | Closed through **2.5.2** / CT-R1 | LIVE Verified | RO-006 / PB-008 |
| **Opening Continuity Front (catalogue)** | Open at **2.6** (provisional) | Wave 6 LIVE-complete | Continuity Front law |
| **Next LIVE open after Wave 6 exit** | **2.6** (provisional) | Not commissioned | Continuity Front law |
| **Trust Remediation Front** | **4.1 → 4.2 → 5.1** | LIVE Verified | RO-002 / PB-004 |
| **Publication Front (Wave 0)** | CS1-001 / CS1-002 Approver | Open (honesty gap) | Not waived by Wave 6 |
...
| **Continuity Front** | LIVE closed through **2.5.2** | Student-visible cliff now at 2.6 until successor Volume |
| **Student Reliance Coverage** | Contiguous first-pass CF reliance through **2.5.2** = **14** Learning LOs LIVE (Gamma→Theta); Trust Front independent **24** LOs (Delta); Alpha/Beta live without Approver credit (honesty gap) | EA-008: reliance follows contiguous certified journeys |
...
| 2 | 22 | **14** | 2 | **0** | 6 | Gamma–Theta LIVE |
| 3 | 19 | 0 | 0 | 0 | 19 | — |
...
4. Continuity Front LIVE closed through 2.5.2 (RO-006); next open at **2.6** (Wave 7 not started).  
...
Wave 1–6 LIVE Approver credit stands at **38 / 72 (52.8%)**. Campaign Theta / CS1-008 is **LIVE-complete** for 2.5.1–2.5.2 + CT-R1. Student Continuity Front closed through **2.5.2** LIVE. Wave 7 not started. No forged seals. Until-exam trust not claimed.

**Companions:** `EP001_GOVERNANCE.md` · `EP001_PRODUCTION_ROADMAP.md` · `EP001_WAVE1_PLAN.md` · `EP001_WAVE2_PLAN.md` · `EP003_WAVE3_PLAN.md` · `EP003_COVERAGE_UPDATE.md` · `EP004_WAVE4_PLAN.md` · `EP004_COVERAGE_UPDATE.md` · `EP005_WAVE5_PLAN.md` · `EP005_COVERAGE_UPDATE.md` · `EP006_WAVE6_PLAN.md` · `EP006_COVERAGE_UPDATE.md` · `RO006_*` · `PB008_*` · `CE001_CATALOGUE_COVERAGE.md`
