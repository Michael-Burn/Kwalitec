#!/usr/bin/env python3
"""Real Worked Examples Batch 2 - Continuity Front (Nu / Xi / Omicron).

Injects genuine ``worked_example`` objects into the same 24-package scope as
MCQ Batch 2 (linear regression, GLM structure, Bayesian foundations), then
synchronises catalogue and campaign twins.

Content lives in ``_rwe_batch2_continuity_front_data.json`` beside this module
...
_DATA = Path(__file__).with_name("_rwe_batch2_continuity_front_data.json")
