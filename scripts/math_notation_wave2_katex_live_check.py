#!/usr/bin/env python3
"""Live KaTeX DOM check for representative Wave 2 worked examples.
...
Usage (Chromium via Playwright available)::
    ...
    python scripts/math_notation_wave2_katex_live_check.py
"""
...
os.environ.setdefault("SECRET_KEY", "wave2-katex-live-check")
...
OUT = Path("/tmp/wave2_katex_live")
OUT.mkdir(parents=True, exist_ok=True)

PACKAGES = (
    ("CS1-EP001-PKG-3.2-CI-NORMAL-MEAN-VARIANCE", "ci-normal"),
    ("CS1-EP001-PKG-3.3-CHI-SQUARE-GOF", "chi-gof"),
    ("CS1-EP001-PKG-3.1-BOOTSTRAP-ESTIMATOR", "bootstrap"),
    ("CS1-EP001-PKG-CP-2.5-CLT", "cp-clt"),
)
...
def main() -> int:
    ...
    for pack_id, slug in PACKAGES:
        ...
        substance = substance_from_package(
            pack, curriculum_identity="CS1:wave2-live", topic_id=pack.topic_code
        )
        example = next(
            a
...
"""
    ...
    with sync_playwright() as p:
        ...
        for pack_id, slug in PACKAGES:
            url = f"http://127.0.0.1:8766/{slug}.html"
