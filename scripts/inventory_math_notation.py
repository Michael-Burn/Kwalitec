...
_MANUAL_PROSE_EXCLUSIONS: frozenset[tuple[str, str, str]] = frozenset(
    {
        ...
        # Wave 11 batch 1: catalogue-wide correctly_excluded + needs_manual_review
        # population; human-confirmed prose (parameter/statistic naming, mission
        # chrome, metalinguistic contrast). Package text left byte-identical.
        (
        ...
        # Wave 11 batch 3: catalogue-wide correctly_excluded + needs_manual_review
        # population; human-confirmed prose (η-forms / η-sketches / refuse chrome,
        # Pearson χ² test-family naming, Δ deviance topic label, §3.2 θ naming).
        # Package text left byte-identical for pure exclusions.
        (
            "4.2.4-factors-interactions-cs1014.json",
        ...
        # Wave 11 batch 3 partial migrate with confirmed residual prose θ:
        # (90.2, 109.8) is $-wrapped; both θ mentions stay interpretive contrast
        # prose (same role as items 50/54 in this package).
        (
            "5.1.5-credible-intervals-cs1015.json",
            "worked_example.common_pitfall",
            "97ccdb7abf30abce",
        ),
        # Wave 11 batch 4 (final): catalogue-wide correctly_excluded +
        # needs_manual_review population; human-confirmed prose (μ/Z warrant
        # naming, estimated structurals, coverage-about-μ/θ, H₀ vocabulary,
        # Exponential(λ) law naming, Family→η→link chrome, shallow R² refuse).
        # Package text left byte-identical for pure exclusions.
        (
            "5.1.7-bayesian-credibility-cs1003.json",
            "knowledge_checks[0].explanation",
