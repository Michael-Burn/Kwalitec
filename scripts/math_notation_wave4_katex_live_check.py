#!/usr/bin/env python3
"""Live KaTeX DOM check for representative Wave 4 worked examples.
...
Usage (Chromium via Playwright available)::
    ...
    python scripts/math_notation_wave4_katex_live_check.py
"""
...
os.environ.setdefault("SECRET_KEY", "wave4-katex-live-check")
...
OUT = Path("/tmp/wave4_katex_live")
OUT.mkdir(parents=True, exist_ok=True)

PACKAGES = (
    ("CS1-EP001-PKG-3.2-PREDICTION-INTERVAL", "prediction-interval"),
    ("CS1-EP001-PKG-3.3-BASIC-TESTS", "basic-tests"),
    ("CS1-EP001-PKG-4.2-FIT-INTERPRET", "fit-interpret"),
    ("CS1-EP001-PKG-4.2-GOODNESS-TESTS", "goodness-tests"),
)
...
def main() -> int:
    ...
    for pack_id, slug in PACKAGES:
        ...
        substance = substance_from_package(
            pack, curriculum_identity="CS1:wave4-live", topic_id=pack.topic_code
        )
        example = next(
            a
...
"""
    ...
    with sync_playwright() as p:
        ...
        for pack_id, slug in PACKAGES:
            url = f"http://127.0.0.1:8768/{slug}.html"
