#!/usr/bin/env python3
"""Live KaTeX DOM check for representative Wave 3 worked examples.
...
Usage (Chromium via Playwright available)::
    ...
    python scripts/math_notation_wave3_katex_live_check.py
"""
...
os.environ.setdefault("SECRET_KEY", "wave3-katex-live-check")
...
OUT = Path("/tmp/wave3_katex_live")
OUT.mkdir(parents=True, exist_ok=True)

PACKAGES = (
    ("CS1-EP001-PKG-CX-4.2-DEVIANCE-ESTIMATION", "deviance"),
    ("CS1-EP001-PKG-3.2-CI-PAIRED-MEANS", "ci-paired"),
    ("CS1-EP001-PKG-4.2-MEAN-VARIANCE", "mean-variance"),
    ("CS1-EP001-PKG-3.2-CI-TWO-SAMPLE", "ci-two-sample"),
)
...
def main() -> int:
    ...
    for pack_id, slug in PACKAGES:
        ...
        substance = substance_from_package(
            pack, curriculum_identity="CS1:wave3-live", topic_id=pack.topic_code
        )
        example = next(
            a
...
"""
    ...
    with sync_playwright() as p:
        ...
        for pack_id, slug in PACKAGES:
            url = f"http://127.0.0.1:8767/{slug}.html"
