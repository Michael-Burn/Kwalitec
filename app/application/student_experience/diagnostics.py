"""Diagnostics — immutable Student Experience diagnostic reports."""
...
EXPERIENCE_VERSION = "0.1.0-foundation"


@dataclass(frozen=True)
class DiagnosticReport:
    """Immutable diagnostic snapshot of Student Experience."""
...
class Diagnostics:
    """Build immutable diagnostic reports (no mutation of experience state)."""
    ...
    def report(self) -> DiagnosticReport:
        ...
        return DiagnosticReport(
            ...
            metadata=MappingProxyType(
                {"foundation": True, "ui": False, "persistence": False}
            ),
        )
