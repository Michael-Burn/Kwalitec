"""Canonical product brand identity labels (IAHF-004B).

Presentation-only constants for chrome, badges, and page identity.
Does not affect educational logic, Twin, or recommendations.
"""
