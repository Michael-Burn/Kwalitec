"""Load, score, and distractor-tag checks for the CS1 topic 2.5 LO02 retry item.

cs1008-2.5.2-ar-02 judges a Poisson overlay on individual counts and refuses
treating that overlay as the CLT check for sample means.
"""
...
_LO02 = {
    ...
    "item_id": "cs1008-2.5.2-ar-02",
    "objective_id": "CS1-B-T05-LO02",
    "tags": {
        "b": "single_draw_as_clt_test",
        "c": "skewness_never_averages",
        "d": "mean_distribution_equals_parent",
    },
}
...
def _scoreable(stem: str, item_id: str):
    ...
    substance = substance_from_package(
        pack,
        curriculum_identity=f"CS1:topic25-retry:{stem}",
...
def test_lo02_poisson_overlay_item_loads_scores_and_tags() -> None:
    stem = str(_LO02["stem"])
