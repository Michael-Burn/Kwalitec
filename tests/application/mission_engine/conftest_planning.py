"""Shared fixtures for AP-002D5 Mission planning tests."""
...
def make_decision_context(
    *,
    twin_id: str = "twin-plan-1",
    reasoning_request_id: str = "rr-plan-1",
    evidence_bundle_id: str = "bundle-plan-1",
    session_id: str = "sess-plan-1",
    correlation_id: str = "corr-plan-1",
    observation_set_id: str = "obs-set-plan-1",
...
def make_decision(
    *,
    decision_id: str = "ed:rr-plan-1:bundle-plan-1:mastery_belief_update:concept-bayes",
    ...
    learning_objective_reference: str = "lo-bayes",
    observation_ids: tuple[str, ...] = ("obs-plan-1",),
    evidence_bundle_id: str = "bundle-plan-1",
    reasoning_request_id: str = "rr-plan-1",
    session_id: str = "sess-plan-1",
    correlation_id: str = "corr-plan-1",
