...
class TestCatalogue:
    ...
    def test_topic_4_1_contracts_match_approved_shapes(self):
        ...
        assert "cs1013-4.1.2-ar-01" not in CS1_D_T01_LO02.item_ids
        assert "cs1013-4.1.2-cp-01" not in CS1_D_T01_LO02.item_ids
        assert "cs1013-4.1.3-ar-01" not in CS1_D_T01_LO03.item_ids
        assert "cs1013-4.1.3-cp-01" not in CS1_D_T01_LO03.item_ids
        assert "cs1013-4.1.4-ar-01" not in CS1_D_T01_LO04.item_ids
        assert "cs1013-4.1.4-cp-01" not in CS1_D_T01_LO04.item_ids
        assert "cs1013-4.1.5-ar-01" not in CS1_D_T01_LO05.item_ids
        assert "cs1013-4.1.5-cp-01" not in CS1_D_T01_LO05.item_ids
        for contract, ar, ar02, cp in (
            (
                CS1_D_T01_LO01,
                "cs1003-4.1.1-ar-01",
    ...
    def test_topic_4_2_contracts_match_approved_shapes(self):
        for contract, ar, ar02, cp in (
            ...
            assert ar02.replace("cs1003-", "cs1014-") not in contract.item_ids
...
# ---------------------------------------------------------------------------
# Topic 3.2 LO01: 3-item conceptual; cs1016 tagged but excluded from contract
# ---------------------------------------------------------------------------
...
class TestTopic32LO01Cs1011OnlyExcludesCs1016:
    ...
    primary_ar02 = "cs1011-3.2.1-ar-02"
    ...
    def test_cs1011_two_of_three_ready_even_with_cs1016_incorrect(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
    ...
    def test_cs1011_one_of_three_insufficient_despite_cs1016_correct(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
...
# ---------------------------------------------------------------------------
# Topic 3.2 LO01-LO08: 3-item conceptual ready_min_correct=2
# (covered by TestConceptualThreeItem and TestFreshSecondAttemptGapClosed)
# ---------------------------------------------------------------------------
...
class TestTopic33LO01Cs1012OnlyExcludesCs1016:
    ...
    primary_ar02 = "cs1012-3.3.1-ar-02"
    ...
    def test_cs1012_two_of_three_ready_even_with_cs1016_incorrect(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
    ...
    def test_cs1012_one_of_three_insufficient_despite_cs1016_correct(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
...
# ---------------------------------------------------------------------------
# Topic 3.3 LO01-LO05: 3-item conceptual ready_min_correct=2
# (covered by TestConceptualThreeItem and TestFreshSecondAttemptGapClosed)
# ---------------------------------------------------------------------------
...
class TestTopic41LO01Cs1003OnlyExcludesTwins:
    ...
    primary_ar02 = "cs1003-4.1.1-ar-02"
    ...
    def test_cs1003_two_of_three_ready_even_with_twins_incorrect(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
    ...
    def test_cs1003_one_of_three_insufficient_despite_twins_correct(self):
        evidence = [
            _record(
                student_id="s1",
                objective_id=self.contract.objective_id,
        ...
        for i, twin_id in enumerate(self.twin_ids, start=3):
            evidence.append(
                _record(
                    student_id="s1",
                    objective_id=self.contract.objective_id,
...
# ---------------------------------------------------------------------------
# Topic 4.1 LO02-LO05: cs1003 only; Continuity twins OEA-tagged but excluded
# ---------------------------------------------------------------------------
...
class TestTopic41LO02ToLO05Cs1003OnlyExcludesCs1013:
    def test_contract_item_ids_exclude_cs1013(
    ...
    def test_cs1003_two_of_three_ready_even_with_cs1013_incorrect(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
    ...
    def test_cs1013_both_correct_does_not_make_ready_without_cs1003(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
    ...
    def test_cs1003_one_of_three_insufficient_despite_cs1013_correct(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
...
# ---------------------------------------------------------------------------
# Topic 4.1 LO01-LO05: 3-item conceptual ready_min_correct=2
# (covered by TestConceptualThreeItem and TestFreshSecondAttemptGapClosed)
# ---------------------------------------------------------------------------


# ---------------------------------------------------------------------------
# Topic 4.2 LO01/LO02/LO03/LO04/LO06/LO07/LO09: 3-item conceptual ready_min_correct=2
# (covered by TestConceptualThreeItem and TestFreshSecondAttemptGapClosed)
# ---------------------------------------------------------------------------


# ---------------------------------------------------------------------------
# Topic 4.2 conceptual LOs: cs1003 only; Continuity twins OEA-tagged but excluded
# ---------------------------------------------------------------------------
...
class TestTopic42ConceptualCs1003OnlyExcludesCs1014:
    def test_contract_item_ids_exclude_cs1014(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        assert contract.item_ids == frozenset(
            {primary_ar, primary_ar02, primary_cp}
    ...
    def test_cs1003_two_of_three_ready_even_with_cs1014_incorrect(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
    ...
    def test_cs1014_both_correct_do_not_make_ready_without_cs1003(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
    ...
    def test_cs1003_one_of_three_insufficient_despite_twins_correct(
        self, contract, primary_ar, primary_ar02, primary_cp, twin_ar, twin_cp
    ):
        evidence = [
            _record(
