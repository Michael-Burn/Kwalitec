...
_PRIOR_ONE_HUNDRED_FORTY_TWO_PACKAGES: tuple[tuple[str, str], ...] = (
    *_PRIOR_ONE_HUNDRED_PACKAGES,
    *_CAF_WAVE5_PACKAGES,
)

_CAF_WAVE6_PACKAGES: tuple[tuple[str, str], ...] = (
    ("revision-confidence-intervals-cs1011", "cs1011-cl-r1-ar-01"),
    ("revision-confidence-intervals-cs1011", "cs1011-cl-r1-cp-01"),
    ("revision-hypothesis-testing-cs1012", "cs1012-cm-r1-ar-01"),
    ("revision-hypothesis-testing-cs1012", "cs1012-cm-r1-cp-01"),
    ("revision-sampling-distributions-cs1009", "cs1009-ci-r1-ar-01"),
    ("revision-sampling-distributions-cs1009", "cs1009-ci-r1-cp-01"),
    ("4.1.1-response-explanatory-cs1003", "cs1003-4.1.1-ar-01"),
    ("4.1.1-response-explanatory-cs1003", "cs1003-4.1.1-cp-01"),
    ("4.1.1-response-explanatory-cs1013", "cs1013-4.1.1-cp-01"),
    ("4.1.1-response-explanatory-cs1013", "cs1013-4.1.1-ar-01"),
    ("4.1.2-simple-multiple-cs1003", "cs1003-4.1.2-ar-01"),
    ("4.1.2-simple-multiple-cs1003", "cs1003-4.1.2-cp-01"),
    ("4.1.2-simple-multiple-cs1013", "cs1013-4.1.2-cp-01"),
    ("4.1.2-simple-multiple-cs1013", "cs1013-4.1.2-ar-01"),
    ("4.1.3-least-squares-cs1003", "cs1003-4.1.3-ar-01"),
    ("4.1.3-least-squares-cs1003", "cs1003-4.1.3-cp-01"),
    ("4.1.3-least-squares-cs1013", "cs1013-4.1.3-cp-01"),
    ("4.1.3-least-squares-cs1013", "cs1013-4.1.3-ar-01"),
    ("4.1.4-software-inference-cs1003", "cs1003-4.1.4-ar-01"),
    ("4.1.4-software-inference-cs1003", "cs1003-4.1.4-cp-01"),
    ("4.1.4-software-fit-cs1013", "cs1013-4.1.4-ar-01"),
    ("4.1.4-software-fit-cs1013", "cs1013-4.1.4-cp-01"),
    ("4.1.5-variable-selection-cs1003", "cs1003-4.1.5-ar-01"),
    ("4.1.5-variable-selection-cs1013", "cs1013-4.1.5-ar-01"),
    ("4.1.5-variable-selection-cs1003", "cs1003-4.1.5-cp-01"),
    ("4.1.5-variable-selection-cs1013", "cs1013-4.1.5-cp-01"),
    ("cp-4.1.1-linear-regression-cs1016", "cs1016-4.1.1-ar-01"),
    ("cp-4.1.1-linear-regression-cs1016", "cs1016-4.1.1-cp-01"),
    ("revision-linear-models-cs1003", "cs1003-cd-r1-ar-01"),
    ("revision-linear-models-cs1003", "cs1003-cd-r1-cp-01"),
    ("revision-linear-regression-cs1013", "cs1013-cn-r1-ar-01"),
    ("revision-linear-regression-cs1013", "cs1013-cn-r1-cp-01"),
    ("1.1-purpose-function-ep001", "ep001-1.1-ar-01"),
    ("1.1-purpose-function-ep001", "ep001-1.1-cp-01"),
    ("1.2.1-eda-summaries-ep001", "ep001-1.2a-ar-01"),
    ("1.2.1-eda-summaries-ep001", "ep001-1.2a-cp-01"),
    ("1.2.2-eda-association-ep001", "ep001-1.2b-ar-01"),
    ("1.2.2-eda-association-ep001", "ep001-1.2b-cp-01"),
    ("1.2.3-pca-cs1002", "cs1002-1.2c-ar-01"),
    ("1.2.3-pca-cs1002", "cs1002-1.2c-cp-01"),
    ("revision-purpose-eda-ep001", "ep001-ca-r1-ar-01"),
    ("revision-purpose-eda-ep001", "ep001-ca-r1-cp-01"),
    ("revision-purpose-eda-ep001", "ep001-ca-r1-cp-02"),
)

_PRIOR_ONE_HUNDRED_EIGHTY_FIVE_PACKAGES: tuple[tuple[str, str], ...] = (
    *_PRIOR_ONE_HUNDRED_FORTY_TWO_PACKAGES,
    *_CAF_WAVE6_PACKAGES,
)

_CAF_FINAL_WAVE_PACKAGES: tuple[tuple[str, str], ...] = (
    ("cr-1.1.1-aims-analysis-cs1017", "cs1017-1.1.1-ar-01"),
    ("cr-1.1.1-aims-analysis-cs1017", "cs1017-1.1.1-cp-01"),
    ("cr-1.1.2-stages-tools-cs1017", "cs1017-1.1.2-ar-01"),
    ("cr-1.1.2-stages-tools-cs1017", "cs1017-1.1.2-cp-01"),
    ("cr-1.1.3-data-sources-cs1017", "cs1017-1.1.3-ar-01"),
    ("cr-1.1.3-data-sources-cs1017", "cs1017-1.1.3-cp-01"),
    ("cr-1.1.4-reproducible-cs1017", "cs1017-1.1.4-ar-01"),
    ("cr-1.1.4-reproducible-cs1017", "cs1017-1.1.4-cp-01"),
    ("cr-1.2.1-eda-summaries-cs1017", "cs1017-1.2.1-ar-01"),
    ("cr-1.2.1-eda-summaries-cs1017", "cs1017-1.2.1-cp-01"),
    ("cr-1.2.2-correlation-cs1017", "cs1017-1.2.2-ar-01"),
    ("cr-1.2.2-correlation-cs1017", "cs1017-1.2.2-cp-01"),
    ("cr-1.2.3-pca-cs1017", "cs1017-1.2.3-ar-01"),
    ("cr-1.2.3-pca-cs1017", "cs1017-1.2.3-cp-01"),
    ("cr-revision-publication-front-cs1017", "cs1017-cr-r1-ar-01"),
    ("cr-revision-publication-front-cs1017", "cs1017-cr-r1-cp-01"),
    ("2.6.1-random-samples-cs1009", "cs1009-2.6.1-ar-01"),
    ("2.6.1-random-samples-cs1009", "cs1009-2.6.1-cp-01"),
    ("cp-2.6.1-random-samples-cs1016", "cs1016-2.6.1-ar-01"),
    ("cp-2.6.1-random-samples-cs1016", "cs1016-2.6.1-cp-01"),
    ("2.6.2-sampling-distribution-statistic-cs1009", "cs1009-2.6.2-ar-01"),
    ("2.6.2-sampling-distribution-statistic-cs1009", "cs1009-2.6.2-cp-01"),
    ("2.6.3-mean-var-sample-cs1009", "cs1009-2.6.3-ar-01"),
    ("2.6.3-mean-var-sample-cs1009", "cs1009-2.6.3-cp-01"),
    ("2.6.4-normal-sample-mean-var-cs1009", "cs1009-2.6.4-ar-01"),
    ("2.6.4-normal-sample-mean-var-cs1009", "cs1009-2.6.4-cp-01"),
    ("2.6.5-t-statistic-cs1009", "cs1009-2.6.5-ar-01"),
    ("2.6.5-t-statistic-cs1009", "cs1009-2.6.5-cp-01"),
    ("2.6.6-f-distribution-cs1009", "cs1009-2.6.6-ar-01"),
    ("2.6.6-f-distribution-cs1009", "cs1009-2.6.6-cp-01"),
    ("2.4.1-mgf-cgf-cs1007", "cs1007-2.4.1-ar-01"),
    ("2.4.1-mgf-cgf-cs1007", "cs1007-2.4.1-cp-01"),
    ("2.4.2-moment-via-gf-cs1007", "cs1007-2.4.2-ar-01"),
    ("2.4.2-moment-via-gf-cs1007", "cs1007-2.4.2-cp-01"),
    ("2.5.1-clt-cs1008", "cs1008-2.5.1-ar-01"),
    ("cp-2.5.1-clt-cs1016", "cs1016-2.5.1-ar-01"),
    ("2.5.2-simulated-sample-normal-cs1008", "cs1008-2.5.2-ar-01"),
    ("2.5.2-simulated-sample-normal-cs1008", "cs1008-2.5.2-cp-01"),
    ("revision-central-limit-theorem-cs1008", "cs1008-ct-r1-ar-01"),
    ("revision-central-limit-theorem-cs1008", "cs1008-ct-r1-cp-01"),
    ("revision-generating-functions-cs1007", "cs1007-ch-r1-ar-01"),
    ("revision-generating-functions-cs1007", "cs1007-ch-r1-cp-01"),
    ("cp-revision-spine-memory-cs1016", "cs1016-cp-r1-ar-01"),
    ("cp-revision-spine-memory-cs1016", "cs1016-cp-r1-cp-01"),
    ("revision-pca-distributions-cs1002", "cs1002-cb-r1-ar-01"),
    ("revision-pca-distributions-cs1002", "cs1002-cb-r1-cp-01"),
    ("revision-pca-distributions-cs1002", "cs1002-cb-r1-cp-02"),
    ("revision-pca-distributions-cs1002", "cs1002-cb-r1-cp-03"),
)

_CS1017_SYLLABUS_GAP_PACKAGES: tuple[tuple[str, str], ...] = (
    ("cr-1.1.3-data-sources-cs1017", "cs1017-1.1.3-ar-02"),
    ("cr-1.1.4-reproducible-cs1017", "cs1017-1.1.4-ar-02"),
)

_CS1004_TOPIC21_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("2.1.4-poisson-process-cs1004", "cs1004-2.1d-ar-02"),
    ("2.1.5-inverse-transform-cs1004", "cs1004-2.1e-ar-02"),
    ("2.1.6-software-generation-cs1004", "cs1004-2.1f-ar-02"),
)

_CS1005_TOPIC22_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("2.2.2-independence-cs1005", "cs1005-2.2.2-ar-02"),
)

_CS1007_TOPIC24_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("2.4.1-mgf-cgf-cs1007", "cs1007-2.4.1-ar-02"),
    ("2.4.2-moment-via-gf-cs1007", "cs1007-2.4.2-ar-02"),
)

_CS1008_TOPIC25_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
...
_CS1010_TOPIC31_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("3.1.3-efficiency-bias-consistency-mse-cs1010", "cs1010-3.1.3-ar-02"),
    ("3.1.4-comparison-mse-cs1010", "cs1010-3.1.4-ar-02"),
    ("3.1.5-asymptotic-mle-cs1010", "cs1010-3.1.5-ar-02"),
)

_CS1011_TOPIC32_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("3.2.1-confidence-interval-parameter-cs1011", "cs1011-3.2.1-ar-02"),
    ("3.2.2-prediction-interval-cs1011", "cs1011-3.2.2-ar-02"),
    ("3.2.3-ci-given-sampling-distribution-cs1011", "cs1011-3.2.3-ar-02"),
    ("3.2.4-ci-normal-mean-variance-cs1011", "cs1011-3.2.4-ar-02"),
    ("3.2.5-ci-binomial-poisson-cs1011", "cs1011-3.2.5-ar-02"),
    ("3.2.6-ci-two-sample-cs1011", "cs1011-3.2.6-ar-02"),
    ("3.2.7-ci-paired-means-cs1011", "cs1011-3.2.7-ar-02"),
    ("3.2.8-bootstrap-confidence-interval-cs1011", "cs1011-3.2.8-ar-02"),
)

_CS1012_TOPIC33_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("3.3.1-hypothesis-concepts-cs1012", "cs1012-3.3.1-ar-02"),
    ("3.3.2-basic-tests-cs1012", "cs1012-3.3.2-ar-02"),
    ("3.3.3-permutation-tests-cs1012", "cs1012-3.3.3-ar-02"),
    ("3.3.4-chi-square-gof-cs1012", "cs1012-3.3.4-ar-02"),
...
_CS1003_TOPIC42_RETRY_PACKAGES: tuple[tuple[str, str], ...] = (
    ("4.2.1-exponential-family-cs1003", "cs1003-4.2.1-ar-02"),
    ("4.2.2-mean-variance-cs1003", "cs1003-4.2.2-ar-02"),
    ("4.2.3-link-canonical-cs1003", "cs1003-4.2.3-ar-02"),
    ("4.2.4-factors-interactions-cs1003", "cs1003-4.2.4-ar-02"),
    ("4.2.6-deviance-estimation-cs1003", "cs1003-4.2.6-ar-02"),
    ("4.2.7-model-choice-cs1003", "cs1003-4.2.7-ar-02"),
...
_PROTOTYPE_PACKAGES: tuple[tuple[str, str], ...] = (
    ...
    *_CAF_FINAL_WAVE_PACKAGES,
    *_CS1017_SYLLABUS_GAP_PACKAGES,
    *_CS1004_TOPIC21_RETRY_PACKAGES,
...
_CREDIBILITY_WAVE_FEEDBACK: dict[tuple[str, str], str] = {
    ...
    (
        ...
        "supplies mu and k; Z = n/(n+k) with individual experience, and "
        "need not be 1."
    ),
    (
        "cs1015-5.1.7-ar-01",
    ...
    (
        ...
        "mu and k; Z = n/(n+k) also uses the amount of individual "
        "experience."
    ),
    (
        "cs1015-5.1.7-ar-01",
        ...
        "premium object is Z times X-bar plus one minus Z times mu, with mu "
        "and k from the prior structure and Z = n/(n+k) from that "
        "structure together with individual experience."
    ),
    (
        "cs1003-5.1.8-ar-01",
        "b",
...
_PRIOR_ONE_HUNDRED_FORTY_TWO_FEEDBACK: dict[tuple[str, str], str] = {
    **_PRIOR_ONE_HUNDRED_FEEDBACK,
    **_CAF_WAVE5_FEEDBACK,
}

_CAF_WAVE6_FEEDBACK: dict[tuple[str, str], str] = {
    # --- cs1011-cl-r1-ar-01 ---
    (
        "cs1011-cl-r1-ar-01",
        "b",
...
_PRIOR_ONE_HUNDRED_EIGHTY_FIVE_FEEDBACK: dict[tuple[str, str], str] = {
    **_PRIOR_ONE_HUNDRED_FORTY_TWO_FEEDBACK,
    **_CAF_WAVE6_FEEDBACK,
}

_CAF_FINAL_WAVE_FEEDBACK: dict[tuple[str, str], str] = {
    # --- cs1017-1.1.1-ar-01 ---
    (
        "cs1017-1.1.1-ar-01",
        "b",
...
def test_prototype_allowlist_is_exactly_two_hundred_thirty_eight_items() -> None:
    ...
    assert len(_PRIOR_ONE_HUNDRED_FORTY_TWO_PACKAGES) == 142
    assert len(_CAF_WAVE6_PACKAGES) == 43
    assert len(_PRIOR_ONE_HUNDRED_EIGHTY_FIVE_PACKAGES) == 185
    assert len(_CAF_FINAL_WAVE_PACKAGES) == 48
    assert len(_CS1017_SYLLABUS_GAP_PACKAGES) == 2
...
def test_cs1003_412_ar01_choice_c_hat_beta_subscripts_valid() -> None:
    """Markup fix: choice c uses closed \\hat{\\beta}_{0/1}, not $\\hat{\\beta}$0."""
    from app.presentation.session.math_markup import prepare_math_markup

    item = _scoreable_for("cs1003-4.1.2-ar-01")
    label = next(c[1] for c in item.choices if c[0] == "c")
    assert r"\hat{\beta}$0" not in label
    assert r"\hat{\beta}$1" not in label
    assert "$_" not in label
    assert r"\hat{\beta}_{0}" in label
    assert r"\hat{\beta}_{1}" in label
    assert prepare_math_markup(label) == label


def test_prior_one_hundred_forty_two_live_items_unaffected() -> None:
    """CAF Wave 6 must leave the prior 142 choice-aware items byte-identical."""
    prior_ids = {want for _, want in _PRIOR_ONE_HUNDRED_FORTY_TWO_PACKAGES}
    assert prior_ids <= PROTOTYPE_ITEM_IDS
    assert len(prior_ids) == 142
    assert len(_PRIOR_ONE_HUNDRED_FORTY_TWO_FEEDBACK) == 426
    for key, frozen in _PRIOR_ONE_HUNDRED_FORTY_TWO_FEEDBACK.items():
        assert PROTOTYPE_CHOICE_FEEDBACK[key] == frozen
    for item_id in sorted(prior_ids):
        item = _scoreable_for(item_id)
        correct_id = item.answer_key.correct_choice_id
        for choice in item.choices:
            ...
            scored = score_practice_response(item, cid)
            assert scored.correct is False
            assert scored.common_mistake == _PRIOR_ONE_HUNDRED_FORTY_TWO_FEEDBACK[(item_id, cid)]


def test_caf_wave6_items_yield_specific_choice_aware_feedback() -> None:
    """Each of the 43 Wave 6 items returns approved copy for every wrong choice."""
    assert len(_CAF_WAVE6_FEEDBACK) == 129
    for _, item_id in _CAF_WAVE6_PACKAGES:
        item = _scoreable_for(item_id)
        assert item.response_type is PracticeResponseType.MCQ
        correct_id = item.answer_key.correct_choice_id
        assert correct_id == "a"
        ...
        for choice in item.choices:
            ...
            scored = score_practice_response(item, cid)
            assert scored.scored is True and scored.correct is False
            expected = _CAF_WAVE6_FEEDBACK[(item_id, cid)]
            assert PROTOTYPE_CHOICE_FEEDBACK[(item_id, cid)] == expected
            assert scored.common_mistake == expected
            assert scored.common_mistake != item.common_mistake
            assert "—" not in expected
...
def test_thirty_live_numeric_checkpoints_unaffected_by_caf_wave6() -> None:
    """Wave 6 adds no numeric conversions; the existing 30 numeric CPs stay numeric."""
    from tests.application.learning_session.test_numeric_parse import (
        LIVE_NUMERIC_ACCEPTED,
    )
...
def test_caf_wave6_live_render_in_session_feedback(app) -> None:
    """Sample newly wired CAF items display correctly, including markup-fixed AR."""
    caf_samples = (
        ("cs1011-cl-r1-ar-01", "b"),
        ("cs1003-4.1.2-ar-01", "c"),
        ("cs1003-4.1.5-cp-01", "d"),
        ("ep001-1.1-ar-01", "b"),
        ("ep001-ca-r1-cp-02", "c"),
    )
    for item_id, choice_id in caf_samples:
    ...
    # Markup-fixed choice label keeps closed hat-beta subscripts through prep.
    from app.presentation.session.math_markup import prepare_math_markup
...
_SUPERSEDED_EA005_ITEMS: frozenset[str] = frozenset(
    {
        "ea005-4.2-ar-01",
        "ea005-4.2-cp-01",
    }
...
def test_prior_one_hundred_eighty_five_live_items_unaffected() -> None:
    """CAF Final Wave must leave the prior 185 choice-aware items byte-identical."""
    prior_ids = {want for _, want in _PRIOR_ONE_HUNDRED_EIGHTY_FIVE_PACKAGES}
    assert prior_ids <= PROTOTYPE_ITEM_IDS
    assert len(prior_ids) == 185
    assert len(_PRIOR_ONE_HUNDRED_EIGHTY_FIVE_FEEDBACK) == 555
    for key, frozen in _PRIOR_ONE_HUNDRED_EIGHTY_FIVE_FEEDBACK.items():
        assert PROTOTYPE_CHOICE_FEEDBACK[key] == frozen
    for item_id in sorted(prior_ids):
        item = _scoreable_for(item_id)
        correct_id = item.answer_key.correct_choice_id
        for choice in item.choices:
            ...
            scored = score_practice_response(item, cid)
            assert scored.correct is False
            assert scored.common_mistake == _PRIOR_ONE_HUNDRED_EIGHTY_FIVE_FEEDBACK[
                (item_id, cid)
            ]


def test_caf_final_wave_items_yield_specific_choice_aware_feedback() -> None:
    """Each of the 48 Final Wave items returns approved copy for every wrong choice."""
    assert len(_CAF_FINAL_WAVE_FEEDBACK) == 144
    for _, item_id in _CAF_FINAL_WAVE_PACKAGES:
        item = _scoreable_for(item_id)
        assert item.response_type is PracticeResponseType.MCQ
        correct_id = item.answer_key.correct_choice_id
        assert correct_id == "a"
        ...
        for choice in item.choices:
            ...
            scored = score_practice_response(item, cid)
            assert scored.scored is True and scored.correct is False
            expected = _CAF_FINAL_WAVE_FEEDBACK[(item_id, cid)]
            assert PROTOTYPE_CHOICE_FEEDBACK[(item_id, cid)] == expected
            assert scored.common_mistake == expected
            assert scored.common_mistake != item.common_mistake
            assert "—" not in expected
    ...
    # Companion twins use independently drafted copy, not sibling paste.
    for letter in ("b", "c", "d"):
        assert (
            _CAF_FINAL_WAVE_FEEDBACK[("cs1016-2.6.1-ar-01", letter)]
            != _CAF_FINAL_WAVE_FEEDBACK[("cs1009-2.6.1-ar-01", letter)]
        )
        assert (
            _CAF_FINAL_WAVE_FEEDBACK[("cs1016-2.6.1-cp-01", letter)]
            != _CAF_FINAL_WAVE_FEEDBACK[("cs1009-2.6.1-cp-01", letter)]
        )
        assert (
            _CAF_FINAL_WAVE_FEEDBACK[("cs1016-2.5.1-ar-01", letter)]
            != _CAF_FINAL_WAVE_FEEDBACK[("cs1008-2.5.1-ar-01", letter)]
        )


def test_superseded_ea005_items_excluded_from_choice_aware_allowlist() -> None:
    """Superseded ea005-4.2 leftovers stay off the allowlist with no CAF wiring."""
    for item_id in sorted(_SUPERSEDED_EA005_ITEMS):
        assert item_id not in PROTOTYPE_ITEM_IDS
        assert not any(k[0] == item_id for k in PROTOTYPE_CHOICE_FEEDBACK)
        assert item_id not in {want for _, want in _PROTOTYPE_PACKAGES}
        assert item_id not in {want for _, want in _CAF_FINAL_WAVE_PACKAGES}


def test_thirty_live_numeric_checkpoints_unaffected_by_caf_final_wave() -> None:
    """Final Wave adds no numeric conversions; existing 30 numeric CPs stay."""
    from tests.application.learning_session.test_numeric_parse import (
        LIVE_NUMERIC_ACCEPTED,
    )
...
def test_caf_final_wave_live_render_in_session_feedback(app) -> None:
    """Sample newly wired Final Wave items display correctly in session HTML."""
    caf_samples = (
        ("cs1017-1.1.1-ar-01", "b"),
        ("cs1016-2.6.1-ar-01", "c"),
        ("cs1016-2.5.1-ar-01", "b"),
        ("cs1017-cr-r1-ar-01", "d"),
        ("cs1002-cb-r1-cp-03", "c"),
    )
    for item_id, choice_id in caf_samples:
        item = _scoreable_for(item_id)
        scored = score_practice_response(item, choice_id)
...
def test_remaining_mcq_without_choice_aware_are_only_superseded_ea005() -> None:
    """Only the two superseded ea005 MCQs remain without choice-aware feedback."""
    import json
    from pathlib import Path

    reset_educational_package_cache()
    # Approved catalogue: every MCQ should now be on the allowlist.
    remaining_approved: set[str] = set()
    for pack in EducationalPackageLoader().all_approved():
        for check in pack.knowledge_checks:
            if check.response_type != "mcq":
                continue
            if check.item_id not in PROTOTYPE_ITEM_IDS:
                remaining_approved.add(check.item_id)
    assert remaining_approved == set()

    # Full JSON walk (approved + superseded) still sees only ea005 unwired.
    root = Path("app/curriculum/data/educational_packages/cs1")

    def walk(obj):
        if isinstance(obj, dict):
            if "item_id" in obj and obj.get("response_type") == "mcq":
                yield obj["item_id"]
            for v in obj.values():
                yield from walk(v)
