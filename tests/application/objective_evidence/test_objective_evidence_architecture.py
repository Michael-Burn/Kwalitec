...
# Enumerated tagged sample: 231 prior + 6 topic 2.6 retry AR items = 237
# item ids (26 original foundation + 8 topic 1.1 + 4 topic 2.3 + 12 topic 1.2
#  + 12 remaining topic 2.1 items for LO01/LO02/LO05/LO06
#  + 11 topic 2.2 items + 4 topic 2.4 items + 6 topic 2.5 items
#  + 14 topic 2.6 items + 10 topic 3.1 LO02-LO06 items
#  + 26 topic 3.2 items + 12 topic 3.3 items
#  + prior 4.1 LO01/LO04 and 4.2.7 tags already in the early sample;
#  + 12 topic 4.1 LO02/LO03/LO05 items;
#  + 36 newly tagged topic 4.2 LO01-LO06/LO08-LO10 items;
#  + 38 newly tagged topic 5.1 LO01-LO09 items appended below;
#  + 2 CS1-017 syllabus-gap AR items (1.1.3-ar-02, 1.1.4-ar-02);
#  + 3 topic 2.1 retry AR items (2.1d-ar-02, 2.1e-ar-02, 2.1f-ar-02);
#  + 1 topic 2.2 LO02 retry AR item (2.2.2-ar-02);
...
#  + 8 topic 3.2 retry AR items (3.2.1-ar-02 through 3.2.8-ar-02);
#  + 5 topic 3.3 retry AR items (3.3.1-ar-02 through 3.3.5-ar-02);
#  + 5 topic 4.1 retry AR items (4.1.1-ar-02 through 4.1.5-ar-02);
...
TAGGED_ITEMS: tuple[tuple[str, str, str], ...] = (
    ...
    ("4.1.2-simple-multiple-cs1003.json", "cs1003-4.1.2-ar-01", "CS1-D-T01-LO02"),
    ("4.1.2-simple-multiple-cs1003.json", "cs1003-4.1.2-cp-01", "CS1-D-T01-LO02"),
    ("4.1.2-simple-multiple-cs1013.json", "cs1013-4.1.2-ar-01", "CS1-D-T01-LO02"),
    ("4.1.2-simple-multiple-cs1013.json", "cs1013-4.1.2-cp-01", "CS1-D-T01-LO02"),
    ("4.1.3-least-squares-cs1003.json", "cs1003-4.1.3-ar-01", "CS1-D-T01-LO03"),
    ("4.1.3-least-squares-cs1003.json", "cs1003-4.1.3-cp-01", "CS1-D-T01-LO03"),
    ("4.1.3-least-squares-cs1013.json", "cs1013-4.1.3-ar-01", "CS1-D-T01-LO03"),
    ("4.1.3-least-squares-cs1013.json", "cs1013-4.1.3-cp-01", "CS1-D-T01-LO03"),
    (
    ...
    ("4.2.5-linear-predictor-cs1003.json", "cs1003-4.2.5-ar-01", "CS1-D-T02-LO05"),
    ("4.2.5-linear-predictor-cs1003.json", "cs1003-4.2.5-cp-01", "CS1-D-T02-LO05"),
    ("4.2.5-linear-predictor-cs1014.json", "cs1014-4.2.5-ar-01", "CS1-D-T02-LO05"),
    ("4.2.5-linear-predictor-cs1014.json", "cs1014-4.2.5-cp-01", "CS1-D-T02-LO05"),
    (
    ...
    ("4.2.8-residuals-cs1003.json", "cs1003-4.2.8-ar-01", "CS1-D-T02-LO08"),
    ("4.2.8-residuals-cs1003.json", "cs1003-4.2.8-cp-01", "CS1-D-T02-LO08"),
    ...
    ("4.2.10-fit-interpret-cs1003.json", "cs1003-4.2.10-ar-01", "CS1-D-T02-LO10"),
    ...
    ("5.1.1-bayes-theorem-cs1015.json", "cs1015-5.1.1-cp-01", "CS1-E-T01-LO01"),
    ...
    ("5.1.4-loss-estimators-cs1003.json", "cs1003-5.1.4-ar-01", "CS1-E-T01-LO04"),
    ("5.1.4-loss-estimators-cs1003.json", "cs1003-5.1.4-cp-01", "CS1-E-T01-LO04"),
    ...
    ("5.1.8-empirical-bayes-cs1003.json", "cs1003-5.1.8-ar-01", "CS1-E-T01-LO08"),
    ("5.1.8-empirical-bayes-cs1003.json", "cs1003-5.1.8-cp-01", "CS1-E-T01-LO08"),
...
# Topic 1.1 (CS1-A-T01) complete slice: all 12 live knowledge checks.
TOPIC_1_1_TAGGED_ITEMS: tuple[tuple[str, str, str], ...] = (
    ...
    ("cr-1.1.2-stages-tools-cs1017.json", "cs1017-1.1.2-cp-01", "CS1-A-T01-LO02"),
    ("cr-1.1.3-data-sources-cs1017.json", "cs1017-1.1.3-ar-01", "CS1-A-T01-LO03"),
    ("cr-1.1.3-data-sources-cs1017.json", "cs1017-1.1.3-ar-02", "CS1-A-T01-LO03"),
    ("cr-1.1.3-data-sources-cs1017.json", "cs1017-1.1.3-cp-01", "CS1-A-T01-LO03"),
    ("cr-1.1.4-reproducible-cs1017.json", "cs1017-1.1.4-ar-01", "CS1-A-T01-LO04"),
    ("cr-1.1.4-reproducible-cs1017.json", "cs1017-1.1.4-ar-02", "CS1-A-T01-LO04"),
    ("cr-1.1.4-reproducible-cs1017.json", "cs1017-1.1.4-cp-01", "CS1-A-T01-LO04"),
    ("1.1-purpose-function-ep001.json", "ep001-1.1-ar-01", "CS1-A-T01-LO01"),
    ("1.1-purpose-function-ep001.json", "ep001-1.1-cp-01", "CS1-A-T01-LO02"),
)
...
# Topic 2.1 (CS1-B-T01) complete slice: all 21 live knowledge checks.
TOPIC_2_1_TAGGED_ITEMS: tuple[tuple[str, str, str], ...] = (
    ...
    ("cp-2.1.3-prob-quantiles-cs1016.json", "cs1016-2.1.3-cp-01", "CS1-B-T01-LO03"),
    ("2.1.4-poisson-process-cs1004.json", "cs1004-2.1d-ar-01", "CS1-B-T01-LO04"),
    ("2.1.4-poisson-process-cs1004.json", "cs1004-2.1d-ar-02", "CS1-B-T01-LO04"),
    ("2.1.4-poisson-process-cs1004.json", "cs1004-2.1d-cp-01", "CS1-B-T01-LO04"),
    (
        "2.1.5-inverse-transform-cs1004.json",
        "cs1004-2.1e-ar-01",
...
# Topic 2.2 (CS1-B-T02) complete slice: all 11 live knowledge checks.
...
# Topic 2.4 (CS1-B-T04) complete slice: all 6 live knowledge checks.
...
# Topic 2.5 (CS1-B-T05) complete slice: all 7 live knowledge checks
# (cs1008 primary + cs1016 Memory Front twin for LO01 + LO02 retry;
...
# Topic 2.6 (CS1-B-T06) complete slice: all 20 live knowledge checks
# (cs1009 primary for LO01-LO06 including six retry AR items + cs1016
# Memory Front twin for LO01; revision left untagged).
...
# Topic 3.2 (CS1-C-T02) complete slice: all 26 live knowledge checks
# (cs1011 primary for LO01-LO08 including eight retry AR items + cs1016 Memory
# Front twin for LO01;
# revision left untagged).
...
# Frozen 135-item foundation before topic 3.3 completion
# (109 through topic 3.1 + topic 3.2 including eight retry AR items).
FOUNDATION_THROUGH_TOPIC_3_2_TAGGED_ITEMS: tuple[tuple[str, str, str], ...] = (
    TAGGED_ITEMS[:135]
)

# Topic 3.3 (CS1-C-T03) complete slice: all 17 live knowledge checks
# (cs1012 primary for LO01-LO05 including five retry AR items + cs1016 Memory
# Front twin for LO01; revision left untagged).
...
# Topic 4.2 (CS1-D-T02) complete slice: all 40 live knowledge checks
...
SAMPLE_OBJECTIVES: tuple[tuple[str, str], ...] = (
    ...
    ("CS1-D-T01-LO02", "4.1.2"),
    ("CS1-D-T01-LO03", "4.1.3"),
    ("CS1-D-T01-LO04", "4.1.4"),
    ("CS1-D-T01-LO05", "4.1.5"),
    ("CS1-D-T02-LO01", "4.2.1"),
    ("CS1-D-T02-LO02", "4.2.2"),
    ("CS1-D-T02-LO03", "4.2.3"),
    ("CS1-D-T02-LO04", "4.2.4"),
    ("CS1-D-T02-LO05", "4.2.5"),
    ("CS1-D-T02-LO06", "4.2.6"),
    ("CS1-D-T02-LO07", "4.2.7"),
    ("CS1-D-T02-LO08", "4.2.8"),
    ("CS1-D-T02-LO09", "4.2.9"),
    ("CS1-D-T02-LO10", "4.2.10"),
    ("CS1-E-T01-LO01", "5.1.1"),
    ("CS1-E-T01-LO02", "5.1.2"),
    ("CS1-E-T01-LO03", "5.1.3"),
    ("CS1-E-T01-LO04", "5.1.4"),
    ("CS1-E-T01-LO05", "5.1.5"),
    ("CS1-E-T01-LO06", "5.1.6"),
    ("CS1-E-T01-LO07", "5.1.7"),
    ("CS1-E-T01-LO08", "5.1.8"),
    ("CS1-E-T01-LO09", "5.1.9"),
...
def test_topic_1_1_all_items_carry_correct_objective_id() -> None:
    """Topic 1.1 has 12 tagged items; each of its 4 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_2_1_all_items_carry_correct_objective_id() -> None:
    """Topic 2.1 has 21 tagged items; each of its 6 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_2_2_all_items_carry_correct_objective_id() -> None:
    """Topic 2.2 has 11 tagged items; each of its 4 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_2_4_all_items_carry_correct_objective_id() -> None:
    """Topic 2.4 has 6 tagged items; each of its 2 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_2_5_all_items_carry_correct_objective_id() -> None:
    """Topic 2.5 has 7 tagged items; each of its 2 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_2_6_all_items_carry_correct_objective_id() -> None:
    """Topic 2.6 has 20 tagged items; each of its 6 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_3_2_all_items_carry_correct_objective_id() -> None:
    """Topic 3.2 has 26 tagged items; each of its 8 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_topic_3_3_all_items_carry_correct_objective_id() -> None:
    """Topic 3.3 has 17 tagged items; each of its 5 LOs has at least one."""
    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
...
def test_foundation_tagged_sample_unaffected_by_topic_3_3_completion() -> None:
    """The prior 135-item foundation mappings are unchanged after topic 3.3."""
    assert len(FOUNDATION_THROUGH_TOPIC_3_2_TAGGED_ITEMS) == 135
    prior_ids = {
        item_id for _, item_id, _ in FOUNDATION_THROUGH_TOPIC_3_2_TAGGED_ITEMS
    }
    assert len(prior_ids) == 135
...
def test_topic_4_2_all_items_carry_correct_objective_id() -> None:
    ...
    topic_4_2_packs = [p for p in loader.all_approved() if p.topic_code == "4.2"]
    assert topic_4_2_packs
    for pack in topic_4_2_packs:
        assert pack.knowledge_checks, f"{pack.package_id} has no knowledge checks"
        for check in pack.knowledge_checks:
            oid = (check.objective_id or "").strip()
            assert oid, f"untagged {pack.package_id}:{check.item_id}"
...
def test_foundation_tagged_sample_unaffected_by_topic_4_2_completion() -> None:
    """The prior 159-item freeze mappings are unchanged after topic 4.2."""
    prior = TAGGED_ITEMS[:159]
    assert len(prior) == 159
    prior_ids = {item_id for _, item_id, _ in prior}
    assert len(prior_ids) == 159

    loader = EducationalPackageLoader(root=LIVE_ROOT)
    packs = {Path(p.source_path).name: p for p in loader.all_approved()}
    for fname, item_id, expected_oid in prior:
        pack = packs[fname]
        match = next(
            (c for c in pack.knowledge_checks if c.item_id == item_id),
            None,
    ...
    new_ids = {
        item_id
        for _, item_id, _ in TOPIC_4_2_TAGGED_ITEMS
        if item_id not in prior_ids
    }
    assert new_ids == {
        "cs1003-4.2.1-ar-01",
...
def test_topic_5_1_all_items_carry_correct_objective_id() -> None:
    ...
    # Every knowledge check on every live topic 5.1 package is tagged.
    # Revision uses topic_code CO-R1 and is intentionally excluded.
    topic_5_1_packs = [p for p in loader.all_approved() if p.topic_code == "5.1"]
    assert topic_5_1_packs
    for pack in topic_5_1_packs:
        assert pack.knowledge_checks, f"{pack.package_id} has no knowledge checks"
        for check in pack.knowledge_checks:
            oid = (check.objective_id or "").strip()
            assert oid, f"untagged {pack.package_id}:{check.item_id}"
...
def test_foundation_tagged_sample_unaffected_by_topic_5_1_completion() -> None:
    """The prior 195-item freeze mappings are unchanged after topic 5.1."""
    prior = TAGGED_ITEMS[:195]
    assert len(prior) == 195
    prior_ids = {item_id for _, item_id, _ in prior}
    ...
    new_ids = {
        item_id
        for _, item_id, _ in TOPIC_5_1_TAGGED_ITEMS
        if item_id not in prior_ids
    }
    assert new_ids == {
        "cs1003-5.1.1-ar-01",
