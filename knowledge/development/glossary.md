...
| **Adaptive Learning** | Mastery / Estimated Knowledge scoring from authorised attempts via `AdaptiveLearningService` (session write-through gated by `SR_SESSION_SQL_EVIDENCE_COMPANION`; production ON via render.yaml). |
