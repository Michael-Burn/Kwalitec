...
|-----------|----------------|
| [`STUDENT_DIGITAL_TWIN.md`](STUDENT_DIGITAL_TWIN.md) | Technical architecture and Version 2 bounded context (*how*) |
...
| Document | Responsibility |
|----------|----------------|
| [`STUDENT_DIGITAL_TWIN.md`](STUDENT_DIGITAL_TWIN.md) | Technical architecture and bounded context — packages, engine contract, inputs/outputs, success criteria |
