...
| D8 | `flask db upgrade` to Alembic head | Head must be `202608300001` |
...
```bash
flask db upgrade
flask db current   # expect 202608300001 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202608300001` will fail writes
