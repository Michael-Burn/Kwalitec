...
| D8 | `flask db upgrade` to Alembic head | Head must be `202607270013` |
...
```bash
flask db upgrade
flask db current   # expect 202607270013 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202607270013` will fail writes
