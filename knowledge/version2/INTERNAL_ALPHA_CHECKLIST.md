...
| D8 | `flask db upgrade` to Alembic head | Head must be `202611140001` |
...
```bash
flask db upgrade
flask db current   # expect 202611140001 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202611140001` will fail writes
