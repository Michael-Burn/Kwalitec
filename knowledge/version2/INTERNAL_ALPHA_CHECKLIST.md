...
| D8 | `flask db upgrade` to Alembic head | Head must be `202609150002` |
...
```bash
flask db upgrade
flask db current   # expect 202609150002 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202609150002` will fail writes
