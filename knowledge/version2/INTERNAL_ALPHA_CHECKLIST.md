...
| D8 | `flask db upgrade` to Alembic head | Head must be `202609160001` |
...
```bash
flask db upgrade
flask db current   # expect 202609160001 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202609160001` will fail writes
