...
| D8 | `flask db upgrade` to Alembic head | Head must be `202609150001` |
...
```bash
flask db upgrade
flask db current   # expect 202609150001 (head)
```
...
- Enabling durable flags **without** `flask db upgrade` to `202609150001` will fail writes
