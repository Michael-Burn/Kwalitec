...
| **ER-TD-H04** | `pip-audit` soft gate — known advisories may ship | DEPENDENCY_AUDIT_V2 · G10.5 | Security + Release | Hard-fail on Critical; HOLD policy for accepted Mediums | Before V1 tag |
