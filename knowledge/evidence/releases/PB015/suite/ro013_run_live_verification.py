...
CERT = ROOT / "certified"
EVID_REPO = Path(
    "/Users/kwalitec/Developer/kwalitec/knowledge/evidence/releases/RO013"
)
EXPECTED_COMMIT = "8432f6a8ddd06a07c20aab146ecceca7578ec116"
...
SNIPPETS = {
    "CK-D1": load_snippets(CERT / "3.1.1-method-of-moments-cs1010.json"),
    "CK-D2": load_snippets(CERT / "3.1.2-maximum-likelihood-cs1010.json"),
    "CK-D3": load_snippets(CERT / "3.1.3-efficiency-bias-consistency-mse-cs1010.json"),
    "CK-D4": load_snippets(CERT / "3.1.4-comparison-mse-cs1010.json"),
    "CK-D5": load_snippets(CERT / "3.1.5-asymptotic-mle-cs1010.json"),
    "CK-D6": load_snippets(CERT / "3.1.6-bootstrap-estimator-cs1010.json"),
    "CK-R1": load_snippets(CERT / "revision-estimators-cs1010.json"),
    "CL-D1": load_snippets(CERT / "3.2.1-confidence-interval-parameter-cs1011.json"),
    "CL-D2": load_snippets(CERT / "3.2.2-prediction-interval-cs1011.json"),
    "CL-D3": load_snippets(CERT / "3.2.3-ci-given-sampling-distribution-cs1011.json"),
    "CL-D4": load_snippets(CERT / "3.2.4-ci-normal-mean-variance-cs1011.json"),
    "CL-D5": load_snippets(CERT / "3.2.5-ci-binomial-poisson-cs1011.json"),
    "CL-D6": load_snippets(CERT / "3.2.6-ci-two-sample-cs1011.json"),
    "CL-D7": load_snippets(CERT / "3.2.7-ci-paired-means-cs1011.json"),
    "CL-D8": load_snippets(CERT / "3.2.8-bootstrap-confidence-interval-cs1011.json"),
    "CL-R1": load_snippets(CERT / "revision-confidence-intervals-cs1011.json"),
    "CM-D1": load_snippets(CERT / "3.3.1-hypothesis-concepts-cs1012.json"),
    "CM-D2": load_snippets(CERT / "3.3.2-basic-tests-cs1012.json"),
    "CM-D3": load_snippets(CERT / "3.3.3-permutation-tests-cs1012.json"),
    "CM-D4": load_snippets(CERT / "3.3.4-chi-square-gof-cs1012.json"),
    "CM-D5": load_snippets(CERT / "3.3.5-contingency-independence-cs1012.json"),
    "CM-R1": load_snippets(CERT / "revision-hypothesis-testing-cs1012.json"),
    "CN-D1": load_snippets(CERT / "4.1.1-response-explanatory-cs1013.json"),
    "CN-D2": load_snippets(CERT / "4.1.2-simple-multiple-cs1013.json"),
    "CN-D3": load_snippets(CERT / "4.1.3-least-squares-cs1013.json"),
    "CN-D4": load_snippets(CERT / "4.1.4-software-fit-cs1013.json"),
    "CN-D5": load_snippets(CERT / "4.1.5-variable-selection-cs1013.json"),
    "CN-R1": load_snippets(CERT / "revision-linear-regression-cs1013.json"),
    "CX-D1": load_snippets(CERT / "4.2.1-exponential-family-cs1014.json"),
    "CX-D2": load_snippets(CERT / "4.2.2-mean-variance-cs1014.json"),
    "CX-D3": load_snippets(CERT / "4.2.3-link-canonical-cs1014.json"),
    "CX-D4": load_snippets(CERT / "4.2.4-factors-interactions-cs1014.json"),
    "CX-D5": load_snippets(CERT / "4.2.5-linear-predictor-cs1014.json"),
    "CX-D6": load_snippets(CERT / "4.2.6-deviance-estimation-cs1014.json"),
    "CX-D7": load_snippets(CERT / "4.2.7-model-choice-cs1014.json"),
    "CX-D8": load_snippets(CERT / "4.2.8-residuals-cs1014.json"),
    "CX-D9": load_snippets(CERT / "4.2.9-goodness-tests-cs1014.json"),
    "CX-D10": load_snippets(CERT / "4.2.10-fit-interpret-cs1014.json"),
    "CX-R1": load_snippets(CERT / "revision-glm-cs1014.json"),
    "CO-D1": load_snippets(CERT / "5.1.1-bayes-theorem-cs1015.json"),
    "CO-D2": load_snippets(CERT / "5.1.2-prior-posterior-cs1015.json"),
    "CO-D3": load_snippets(CERT / "5.1.3-posterior-simple-cs1015.json"),
    "CO-D4": load_snippets(CERT / "5.1.4-loss-estimators-cs1015.json"),
    "CO-D5": load_snippets(CERT / "5.1.5-credible-intervals-cs1015.json"),
    "CO-D6": load_snippets(CERT / "5.1.6-credibility-premium-cs1015.json"),
    "CO-D7": load_snippets(CERT / "5.1.7-bayesian-credibility-cs1015.json"),
    "CO-D8": load_snippets(CERT / "5.1.8-empirical-bayes-cs1015.json"),
    "CO-D9": load_snippets(CERT / "5.1.9-bayes-vs-eb-cs1015.json"),
    "CO-R1": load_snippets(CERT / "revision-bayesian-cs1015.json"),
}

EXPECTED_CHAIN = [
    "CK-D1","CK-D2","CK-D3","CK-D4","CK-D5","CK-D6","CK-R1",
    "CL-D1","CL-D2","CL-D3","CL-D4","CL-D5","CL-D6","CL-D7","CL-D8","CL-R1",
    "CM-D1","CM-D2","CM-D3","CM-D4","CM-D5","CM-R1",
    "CN-D1","CN-D2","CN-D3","CN-D4","CN-D5","CN-R1",
    "CX-D1","CX-D2","CX-D3","CX-D4","CX-D5","CX-D6","CX-D7","CX-D8","CX-D9","CX-D10","CX-R1",
]
    ...
    for i in range(12):
        ...
        if f"/session/{sid}/activity/answer" in html:
            ...
            data = {
                ...
                "activity_id": aid,
                "response": (
                    f"RO-013 day {expected_day}: applied CMP guidance and answered as directed."
                ),
            }
    ...
    if reflection_ok and "csrf_token" in html and "Not Found" not in c.title(html):
        _, final, html = c.post(
            f"/session/{sid}/reflection/continue",
            {
                ...
                "session_id": sid,
                "reflection_note": (
                    f"RO-013 {expected_day}: completed activities; noted stickiest CMP cue."
                ),
                "submit": "Continue",
            },
        )
    ...
    if "completion_status" in html:
        _, final, html = c.post(
            f"/session/{sid}/finish",
            {
                ...
                "notes": f"RO-013 {expected_day}: finished planned study.",
