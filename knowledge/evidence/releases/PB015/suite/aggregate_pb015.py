#!/usr/bin/env python3
"""PB-015 — aggregate persona results into cohort results.json."""
...
probe = m.mod.Client("pb015_agg_probe")
...
(EVID_REPO / "suite" / "run_pb015.py").write_text(SUITE.read_text())
(EVID_REPO / "suite" / "aggregate_pb015.py").write_text(Path(__file__).read_text())
