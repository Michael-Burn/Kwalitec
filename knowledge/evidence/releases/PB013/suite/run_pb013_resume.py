#!/usr/bin/env python3
"""PB-013 resume — remaining personas after partial PASS cohort.
...
probe = m.mod.Client("pb013_resume_probe")
...
regression = m.regression_vs_nu(results)
...
out = {
    ...
    "verdict": overall,
    "resume_kept": list(keep_slugs),
    "resume_rerun": list(resume_slugs),
}
...
(EVID_REPO / "suite" / "run_pb013_resume.py").write_text(Path(__file__).read_text())
