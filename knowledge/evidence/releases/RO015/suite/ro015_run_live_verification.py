...
CERT = ROOT / "certified"
EVID_REPO = Path(
    "/Users/kwalitec/Developer/kwalitec/knowledge/evidence/releases/RO015"
)
EXPECTED_COMMIT = "272a0950ca1a65df01badf5e180c3c06a41681e7"
...
SNIPPETS = {
    "CR-D1": load_snippets(CERT / "1.1.1-aims-analysis-cs1017.json"),
    "CR-D2": load_snippets(CERT / "1.1.2-stages-tools-cs1017.json"),
    "CR-D3": load_snippets(CERT / "1.1.3-data-sources-cs1017.json"),
    "CR-D4": load_snippets(CERT / "1.1.4-reproducible-cs1017.json"),
    "CR-D5": load_snippets(CERT / "1.2.1-eda-summaries-cs1017.json"),
    "CR-D6": load_snippets(CERT / "1.2.2-correlation-cs1017.json"),
    "CR-D7": load_snippets(CERT / "1.2.3-pca-cs1017.json"),
    "CR-D8": load_snippets(CERT / "2.1.1-discrete-cs1017.json"),
    "CR-D9": load_snippets(CERT / "2.1.2-continuous-cs1017.json"),
    "CR-R1": load_snippets(CERT / "revision-publication-front-cs1017.json"),
}
