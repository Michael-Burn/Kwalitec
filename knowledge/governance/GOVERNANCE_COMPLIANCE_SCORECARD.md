...
2. ~~**Tip / Mission / Session noun storm** (NCR-015 / NCR-020)~~ — **Closed in-scope RR-001.3A**; Journal/Timeline empties **Closed RR-001.3C**  
...
| Decision Journal | F | F | F | F | F | F | F | F | F | F |
| Educational Timeline | F | F | F | F | F | F | F | F | F | F |
| Feedback Loop | P | F | F | P | F | F | F | F | F | F |
| Revision | P | P | F | P | P | P | P | P | P | P |
| History | F | F | — | F | F | F | P | P | F | F |
| Calibration | F | F | F | F | F | F | — | F | F | F |
| Help | F | F | F | F | F | F | P | P | F | F |
| Notifications | — | — | — | — | — | — | — | — | — | P |
...
| Authority ownership | P | F | P | P | P | P | P | P | P | F |
| Terminology | P | P | — | P | P | P | P | P | P | F |
| Educational memory | F | F | F | F | F | F | F | F | F | F |
