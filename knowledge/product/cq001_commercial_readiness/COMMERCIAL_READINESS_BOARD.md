...
| **As of** | 2026-07-28 |
| **Trend** | Up (+2) after CQ-006 |
| **Prior CRI** | 51% (CQ-005) |
| **Nearest tag** | `cri-50` — composite at provisional band; **tag not created** (validation required) |
| **Current highest-priority programme** | **CQ-006** — completing |
| **Next recommended programme** | Residual Strong-band polish / founder dogfood validation across CR1–CR6 |
...
|---|---|---:|---:|---|---|
| CR1 | Core Study Loop | 18 | 63 | Emerging | Hero density; scarce-time continuity not yet Strong |
| CR2 | Daily Habit Fit | 14 | 57 | Emerging | Fresh-start density; preferred-minutes echo; not yet Strong |
...
| CR5 | Experience Cohesion | 10 | 57 | Emerging | Cross-surface craft improved; residual dual-run / density |
...
| B-CR3-02 | Guidance trust Emerging — Strong needs validated follow-through | CR3 Strong | Founder dogfood / observational evidence |
...
|---|---|---|---|---|
| Completing | CQ-006 Premium Craft | **CR6** (+CR5/CR1/CR2 natural) | **+2 provisional** | Completing |
| Next recommended | Residual Strong-band polish / founder dogfood (CR1–CR6) | TBD | TBD at intake | Proposed — not started |
