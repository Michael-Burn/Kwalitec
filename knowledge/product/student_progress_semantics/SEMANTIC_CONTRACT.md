...
**Status:** Locked Phase 2 semantic contract; Coverage definition amended 2026-09-17 for dual-source reconciliation; live student coverage displays cut over to reconciliation 2026-09-18  
**Date:** 2026-09-16 (Coverage §5.1 amended 2026-09-17; live coverage display cutover 2026-09-18)  
...
**Does not authorize:** Formula merges beyond the locked meanings, Decision Engine wiring, or Educational Framework redesign. Live coverage display cutover for CS1 Study / Stats / Journey / Settings export is authorised under the dual-source Coverage contract (§5.1). Non-CS1 subjects retain prior engines until identity reconciliation exists for them.
...
| **Output / state shape** | Counts and/or percentages of completed Study Progress units over an explicit syllabus denominator; completed / not-completed per unit; journey-style “how far through” derived only from Study Progress. Labels must narrate coverage or study progress, not mastery. Live student coverage displays (Study, Stats, Journey, Settings weekly export) use dual-source reconciliation: CONFIRMED_COVERED and HISTORICALLY_COMPLETED count as covered; AMBIGUOUS_HISTORICAL_ACTIVITY and NOT_COVERED do not. Categories remain auditable with evidence provenance. |
