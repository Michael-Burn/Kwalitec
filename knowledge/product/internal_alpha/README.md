...
Operational and product documentation for the Internal Alpha Stabilization
programme — capabilities that restore student trust before public recommendation
surfaces expand.

## Owner

Architecture Office / Product
...
- Week artefacts under `research/internal_alpha/`
- Runner: `scripts/run_internal_alpha.py`
